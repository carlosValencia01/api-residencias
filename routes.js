module.exports = (wagner) => {
  ...
  return [
    ...
    // SG-CLE
    { route: 'sg-cle/englishstudent', router: routers.englishStudent },
    { route: 'sg-cle/englishcourse', router: routers.englishCourse },
    ...
    // Social-Service
    { route: 'controlStudent', router: routers.controlStudent }
  ];
};
