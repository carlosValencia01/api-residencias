module.exports = (studentData,bossDivEst,_dateSchedule) => {
    return new Promise(async (resolve) => {
        ...
        for(let i = 0; i < materias.length; i++){  
            ...
            listaMaterias += '<tr>'+
                '<th style="width: 19%; font-size:8px; border: 1pt solid black; font-weight: normal;">'+materias[i].subjectCode+'<br>'+materias[i].subjectName+'<br>'+(materias[i].subjectTeacher ? materias[i].subjectTeacher : 'Docente sin asignar')+'</th>'+
            ...
            <table style="width: 100%;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <th style="width: 50%; font-size:10px; font-weight: normal;">${studentData.specialty ? studentData.specialty : 'Sin especialidad'}</th>
                    </tr>
                </tbody>
            </table>
                ...
                <tbody>
                    <tr>
                        <div style="width: 50%; text-align: center;">
                            <image src='https://i.ibb.co/hDk82Jp/Jefe-Div-Est.png' width="110">
                        </div>
